...
--
-- Host: localhost
-- Generation Time: Oct 06, 2017 at 03:26 AM
...
--
-- Table structure for table `e_reference`
--

CREATE TABLE `e_reference` (
  `e_reference_id` int(11) NOT NULL,
  `e_reference_course_code` int(11) NOT NULL,
  `e_reference_file` varchar(255) NOT NULL,
  `e_reference_user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `e_reference`
--
ALTER TABLE `e_reference`
  ADD PRIMARY KEY (`e_reference_id`),
  ADD KEY `e_reference_course_code` (`e_reference_course_code`),
  ADD KEY `e_reference_user_id` (`e_reference_user_id`);
...
--
-- AUTO_INCREMENT for table `e_reference`
--
ALTER TABLE `e_reference`
  MODIFY `e_reference_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `assignment`
  ADD CONSTRAINT `assignment_ibfk_1` FOREIGN KEY (`assignment_course_id`) REFERENCES `enroll` (`enroll_course_code`),
  ADD CONSTRAINT `assignment_ibfk_2` FOREIGN KEY (`assignment_student_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `enroll`
--
ALTER TABLE `enroll`
  ADD CONSTRAINT `enroll_ibfk_1` FOREIGN KEY (`enroll_student_reg_no`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `enroll_ibfk_2` FOREIGN KEY (`enroll_course_code`) REFERENCES `course` (`course_code`);

--
-- Constraints for table `e_reference`
--
ALTER TABLE `e_reference`
  ADD CONSTRAINT `e_reference_ibfk_1` FOREIGN KEY (`e_reference_user_id`) REFERENCES `user` (`user_type_id`);

--
-- Constraints for table `result`
--
ALTER TABLE `result`
  ADD CONSTRAINT `result_ibfk_1` FOREIGN KEY (`result_student_id`) REFERENCES `user` (`id`);
